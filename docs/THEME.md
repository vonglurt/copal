...
| `copal-launcher` | written by stage 16 | Super+Space / D / Z: `copal-menu` → wofi drun → dmenu. The quickshell radial launcher is no longer preferred — it would be a third menu that knows about neither pane |
